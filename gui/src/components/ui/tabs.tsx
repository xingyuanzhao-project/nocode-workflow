/**
 * Shadcn/ui-compatible Tabs primitives built on @radix-ui/react-tabs.
 *
 * Copied from the standard shadcn/ui template so the rest of the
 * GUI can import from ``@/components/ui/tabs`` the same way the
 * shadcn/ui docs show.
 */
